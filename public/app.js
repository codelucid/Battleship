document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkForWins() {
        ...
        if (carrierCount === 5) {
            infoDisplay.innerHTML = "You sunk the computer's aircraft carrier!"
            carrierCount = 10
        }
        ...
        if (cpuCarrierCount === 5) {
            infoDisplay.innerHTML = "Computer sunk your aircraft carrier!"
            cpuCarrierCount = 10
        }
        ...
        if ((cpuDestroyerCount + cpuSubmarineCount + cpuCruiserCount + cpuBattleshipCount + cpuCarrierCount) === 50) {
            infoDisplay.innerHTML = "Computer Won...play again!"
            gameOver()
        }
    }
